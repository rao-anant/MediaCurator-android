...
|---|---|---|---|---|
| Onboarding: self-paced slide deck | §13 | DONE a30 | DONE b16 | replaces the timed animation; Next/Back + dots, one animated slide, dashed "Hidden" shelf so the return never looks resurrected, recap. iOS to mirror the deck + Hidden-shelf device |
